 ...
 */
// Registers for changing the FPS
//  as default:           fps          = 30 fps: F(internal clock) = 24MHz/(0+1)
#define   CAM_REG_CLKRC          0x11           // default: 0x80
#define   CAM_REG_DBLV           0x6B           // default: 0x3A

// Registers for configuring the format (Resolution, Image):
// as default:            resolution   = VGA
//                        Image_format = YUV
#define   CAM_REG_COM3           0x0C           // default: 0x00
#define   CAM_REG_COM7           0x12           // default: 0x00
#define   CAM_REG_COM14          0x3E           // default: 0x0E
#define   CAM_REG_COM15          0x40           // default: 0xC0
...
enum {
  OV7670_STANDBY = 0x0,
  OV7670_STREAMING = 0x1,        // I2C triggered streaming enable
};
