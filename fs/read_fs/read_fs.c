...
int pi_fs_read_async(pi_fs_file_t *file, void *buffer, size_t size, pi_task_t *event)
{
...
int pi_fs_direct_read_async(pi_fs_file_t *file, void *buffer, size_t size, pi_task_t *event)
{
  pi_fs_t *fs = (pi_fs_t *)file->fs->data;
